...
export const getBrowserlessConfig = () => {
...
export const getFinchartImage = async ({ symbol, interval, studies, }) => {
...
`;
export const getOpenAIAnalysis = async (base64Image) => {
...
export const INTERVALS = ["1", "5", "15", "30", "60", "120", "240", "D", "W"];
